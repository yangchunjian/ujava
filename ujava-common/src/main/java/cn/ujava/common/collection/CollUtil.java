...
import cn.ujava.common.collection.iter.ArrayIter;
import cn.ujava.common.collection.iter.IterUtil;
import cn.ujava.common.collection.iter.IteratorEnumeration;
import cn.ujava.common.collection.queue.BoundedPriorityQueue;
import cn.ujava.common.collection.set.SetUtil;
import cn.ujava.common.collection.set.UniqueKeySet;
import cn.ujava.common.comparator.CompareUtil;
import cn.ujava.common.comparator.PinyinComparator;
import cn.ujava.common.comparator.PropertyComparator;
...
import cn.ujava.common.func.SerConsumer3;
...
public class CollUtil {
	 ...
	 * @since 3.0.9
	 */
	public static <K, V> LinkedHashMap<K, V> sortToMap(final Collection<Entry<K, V>> entryCollection, final Comparator<Entry<K, V>> comparator) {
		final List<Entry<K, V>> list = new LinkedList<>(entryCollection);
		list.sort(comparator);
	 ...
	 * @since 3.0.9
	 */
	public static <K, V> LinkedHashMap<K, V> sortByEntry(final Map<K, V> map, final Comparator<Entry<K, V>> comparator) {
