...
import cn.ujava.common.exception.ReflectException;
...
public class ReflectUtil {
    ...
    private static final ClassLoader defaultLoader = ReflectUtil.class.getClassLoader();
    ...
    static {
        ...
        try {
            ...
            protectionDomain = getProtectionDomain(ReflectUtil.class);
