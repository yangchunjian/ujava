...
x=eval(x)  //将符号解转换为数值解
</code></pre><p>MATLAB系统环境</p><p>需要掌握：</p><ol><li><p>MATLAB系统环境熟知</p></li><li><p>MATLAB系统数值数据掌握</p></li><li><p>MATLAB矩阵表示及引用</p></li><li><p>MATLAB语言的基本运算</p></li><li><p>MATLAB操作界面的组成</p></li></ol><figure><img src="`+g+'" alt="img_139.png" tabindex="0" loading="lazy"><figcaption>img_139.png</figcaption></figure><p>（1）MATLAB主窗口</p><p>功能区（3个）、快速访问工具栏、当前文件夹工具栏</p><p>（2）命令行窗口</p><p>命令行窗口用于输入命令并显示命令的执行结果。</p><blockquote><blockquote><p>命令提示符，可以接受并执行Matlab命令。<br><img src="'+e+'" alt="img_140.png" loading="lazy"></p></blockquote></blockquote><p>（3）当前文件夹窗口</p><p>运行时的工作文件夹。方便使用和建立。</p><p>如何设置当前文件夹呢？</p><p>（1）在当前文件夹工具栏或当前文件夹窗口中选择某文件夹为当前文件夹</p><p>（2）使用cd命令</p><p>注意：一定要先建立文件夹，再将这个文件夹设为当前文件夹。<br><img src="'+r+'" alt="img_141.png" loading="lazy"></p><p>（4）工作区窗口</p><p>工作区：也称工作空间，matlab用于存储各种变量和结果的内存空间。</p><p>工作区窗口：用于变量的显示与操作。也可以对变量进行编辑保存和删除等操作。<br><img src="'+l+'" alt="img_142.png" loading="lazy"></p><ol start="2"><li>MATLAB的搜索路径<br><img src="'+a+`" alt="img_143.png" loading="lazy"></li></ol><p>命令对象操作举例：</p><pre><code>&gt;&gt; clear  //清除工作区的全部变量
